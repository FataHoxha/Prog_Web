...
public class UserManager {
    ...
    public @NotNull Boolean isValidResetPasswordToken(final @NotNull String token) {
        int count;
        try(Connection conn = database.open()) {
    ...
    public @NotNull String generateResetPasswordToken(final @NotNull String email) {
