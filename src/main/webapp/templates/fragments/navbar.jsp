        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                <c:if test="${sessionScope.user.isAuthenticated()}">
                    <li><p class="navbar-text">Credito: <strong> <fmt:formatNumber
                            value="${sessionScope.user.getCredit()}" maxFractionDigits="2" type="currency"/></strong>
                    </p></li>
                    <li><p class="navbar-text">Autenticato come <strong>${sessionScope.user.getUsername()}</strong> (<a
                            href="/logout">disconnetti</a>)</p></li>
                </c:if>
                <c:if test="${!sessionScope.user.isAuthenticated()}">
